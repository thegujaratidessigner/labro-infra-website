      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <a href="#home" className="flex-shrink-0 bg-white rounded-lg overflow-hidden">
              <Image
                src="/logo.png"
                alt="Labro Infra"
                width={400}
            ...
            <nav className="flex-1 px-6 py-8 space-y-4">
              {navItems.map((item) => (
                <a
                  ...
                  className="block text-lg font-medium text-gray-700 hover:text-blue-900 py-3 border-b border-gray-100 transition-colors"
                >
                  {item.name}
                </a>
              ))}
