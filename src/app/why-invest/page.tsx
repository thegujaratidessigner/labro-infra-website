...
export default function WhyInvestPage() {
  ...
  const infrastructureItems = [
    ...
    { 
      ...
      image: '/images/ksc/image_10.jpeg'
    },
    { 
      icon: Timer, 
      ...
      image: '/images/ksc/image_11.jpeg'
    },
    { 
      icon: TrendingUp, 
  ...
  const futureVisionItems = [
    { 
      ...
      image: '/images/ksc/image_13.jpeg'
    },
    { 
      icon: Building2, 
      ...
      image: '/images/ksc/image_14.jpeg'
    },
    { 
      icon: GraduationCap, 
      ...
      image: '/images/ksc/image_15.jpeg'
    },
    { 
      icon: Truck, 
    ...
    { 
      ...
      image: '/images/ksc/image_17.jpeg'
    },
    { 
      icon: Sparkles, 
      ...
      image: '/images/ksc/image_18.jpeg'
    },
  ];
            ...
            <div className="mb-20">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 text-center border-2 border-green-200">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Lowest Price Stage Today</h3>
                  <p className="text-gray-600">Maximum future appreciation potential</p>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 text-center border-2 border-blue-200">
                  <Award className="w-16 h-16 text-blue-600 mx-auto mb-4" />
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Maximum Future Appreciation Potential</h3>
                  <p className="text-gray-600">Early-stage investment advantage</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-20">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {howWeHelpItems.map((item, index) => (
                  <div key={index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border-l-4 border-amber-500">
                    <div className="flex items-start gap-4">
                      <div className="bg-amber-500 text-white rounded-full w-12 h-12 flex items-center justify-center flex-shrink-0 font-bold text-xl">
                        {item.number}
                      </div>
